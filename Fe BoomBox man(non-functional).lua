--[[
made by rouxhaver (Burgundy)
(Deleting/Renaming the right arm of a character then attempting to equip a tool will cause the tool to be "loose", works with RCD aswell)
(network ownership updates have caused this script to break)
]]
